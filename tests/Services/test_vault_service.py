...
from backend.models import Vault, Node, Version
...
def test_delete_vault_success(client, auth_headers_1, test_user_1_obj, db_session):
    ...
    # Überprüfen, ob sie vor dem Löschen existieren (optional, aber gute Praxis)
    ...
    # Assert
    # Verwenden Sie db_session.get() für die Überprüfung
