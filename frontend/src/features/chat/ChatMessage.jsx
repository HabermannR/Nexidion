// IN: src/features/chat/ChatMessage.jsx
...
// Die Komponente selbst, fast unverändert
export default function ChatMessage({ message, onResubmitPrompt, isChatLoading, onDelete }) {
    ...
    // Eine Nachricht ist "temporär", wenn sie eine temp-ID hat oder der Server-Status 'pending' ist.
